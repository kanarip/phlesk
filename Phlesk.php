 ...
 */
function contextOut($target, $return = null)
{
 ...
 */
function getAllDomains($main = false, $hosting = false, $mail = false)
{
    $domains = array();
 ...
 */
function getDomainByGuid(String $domain_guid)
{
...
/**
    ...
    @return \Phlesk\Domain|NULL
 */
function getDomainById(Integer $domain_id)
{
    $domain = new \Phlesk\Domain($domain_id);
 ...
 */
function getDomainsByClient(\pm_Client $client, $mainOnly = false)
{
